...
public class ItemAdminRequest extends ItemTable {

	public TextButton btSet;
	public TextButton btDel;

	public ItemAdminRequest(AbstractTable table, String[] strings) {
		super(table);
		...
		btSet = new TextButton("Kích hoạt", Style.ins.textButtonStyle);
		btDel = new TextButton("Hủy", Style.ins.textButtonStyle);
		action.add(btSet).width(120).height(35);
		action.add(btDel).width(80).height(35).padLeft(5);
