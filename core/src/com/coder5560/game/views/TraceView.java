...
public class TraceView {
	...
	public void addViewToTrace(String name) {
		...
		if (name.equalsIgnoreCase(StringSystem.VIEW_ACTION_BAR)
				|| name.equalsIgnoreCase(StringSystem.VIEW_MAIN_MENU))
			return;

		if (traceView.size > 1 && name.equalsIgnoreCase(getLastView()))
			return;
