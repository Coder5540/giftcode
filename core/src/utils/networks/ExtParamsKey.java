...
public class ExtParamsKey {
	...
	public static final String	NUMBER_UNSEEN				= "number_unseen";
	...
	public static final String	AGENCY_TRANSFER				= "agency_transfer";
	public static final String	AGENCY_TRANSFER_FULL_NAME	= "agency_transfer_full_name";
	...
	public final static String	IS_SOLD						= "is_sold";
	public final static String	USER_RECHARGE				= "user_recharge";
	public final static String	REMOVE_DATE					= "remove_date";
